...
module N_ary_functions : sig
  ...
  type function_param_desc =
    ...
    *)
    | Pparam_newtype of string Asttypes.loc * Jane_asttypes.layout_annotation option
...
module Layouts : sig
  ...
  type nonrec expression =
    ...
    | Lexp_newtype of
        string Location.loc * Jane_asttypes.layout_annotation * Parsetree.expression
  ...
  type nonrec core_type =
    ...
    | Ltyp_poly of
        { bound_vars : (string Location.loc * Jane_asttypes.layout_annotation option) list
  ...
  module Pprint : sig
    ...
    val layout_annotation : Format.formatter -> Jane_asttypes.layout_annotation -> unit
  end
  ...
  val constructor_declaration_of
    ...
    -> info:Docstrings.info
    -> vars_layouts:(string Location.loc * Jane_asttypes.layout_annotation option) list
