...
module Layout_annotation : sig
  ...
  module Decode = struct
    ...
    module Desugaring_error = struct
      type error = Wrong_number_of_layouts of int * layout_annotation option list
      ...
      | [ "layout_annotation" ] ->
        Payload
          (fun payload ~loc ->
            ...
            let layout_annotation = Layout_annotation.Decode.from_payload payload ~loc in
            Layout_annotation layout_annotation)
      | _ -> Unknown_suffix
    ;;
    ...
    let report_error ~loc = function
      ...
      | Expected_newtype_with_layout_annotation annotation ->
        Location.errorf
          ...
          Attribute_node.format
          (Attribute_node.Layout_annotation annotation)
      | Parameterless_function ->
        Location.errorf
          ~loc
  ...
  let extract_fun_params =
    ...
    *)
    ...
    let rec loop expr ~rev_params =
      let next_param, continue_or_stop = extract_next_fun_param expr ~layout:None in
      let rev_params =
